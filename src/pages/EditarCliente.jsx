...
export async function loader({params}){
    ...
    if(Object.values(cliente).length === 0){
        throw new Response("",{
            status: 404,
            statusText: "Oe conero sabes escribir? pon una url correcta pe Quispe"
        })
    }
    return cliente
}
...
export async function action({request, params}){
    ...
    if(Object.values(datos).includes("")){  
        errores.push("Todos los campos son olibgatorios")
    }
...
const EditarCliente = () => {
    ...
    return (
        ...
        <div className="bg-white shadow-md rounded-md md:w-3/4 mx-auto px-5 py-10">
